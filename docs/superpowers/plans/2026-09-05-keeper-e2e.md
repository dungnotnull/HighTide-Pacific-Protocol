...
4. `npm run demo:lanina` — expect TRIGGERED lines for TV 2020/2021/2022 with tiers 1.0/0.6/1.0 and PAID lines, ending with "Tuvalu beneficiary balance: 3,677,648 HTD" (1,414,480 + 848,688 + 1,414,480)
